...
//	ArticleApiController 클래스에서 실행했던 데이터베이스 작업을 서비스 클래스에서 실행한다.
//	JPA를 사용한 데이터베이스 작업을 하기 위해서 생성한 JpaRepository 인터페이스를 상속받아 만든 repository 객체를
//	선언하고 초기화한다.
	@Autowired
...
//	트랜잭션 => 실패 => 롤백
	...
	public List<Article> transactionTest(List<ArticleForm> dtos) {
		...
		*/
		...
		// 위에 코딩한 게 잘난 척하려고 람바를 쓰면 한 줄로 코딩이 가능하다.
